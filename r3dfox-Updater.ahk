...
;@Ahk2Exe-SetMainIcon r3dfox.ico
;@Ahk2Exe-AddResource r3dfox.ico, 160
...
, _To                 := "to"
, _GoToWebsite        := "<a>Restart r3dfox Updater</a> or visit the <a>project website</a> for help."
...
Init() {
	...
	Gui, Font, ce6e6e6 s22 w700, Segoe UI
